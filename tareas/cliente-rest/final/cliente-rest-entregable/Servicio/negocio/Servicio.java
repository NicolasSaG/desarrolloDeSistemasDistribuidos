  ...
  public Response alta(@FormParam("usuario") Usuario usuario) throws Exception {
    ...
    try {
      ...
      PreparedStatement stmt_4 = conexion
          .prepareStatement("SELECT id_usuario FROM usuarios ORDER BY id_usuario DESC LIMIT 1");
      try {
    ...
    return Response.ok().entity(id_usuario).build();
  }
  ...
  public Response consulta(@FormParam("id_usuario") Integer id_usuario) throws Exception {
    ...
    try {
      PreparedStatement stmt_1 = conexion.prepareStatement(
          "SELECT a.email,a.nombre,a.apellido_paterno,a.apellido_materno,a.fecha_nacimiento,a.telefono,a.genero FROM usuarios a WHERE id_usuario=?");
      try {
